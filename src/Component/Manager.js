...
const Manager = (props) => {
    ...
    useEffect(() => {
        firebaseDb.child('Manager').on('value', snapshot => {
    ...
    if (window.confirm('Are you sure to delete this record?')) {
        firebaseDb.child(`Manager/${id}`).remove(
            err => {
                if (err)
                    console.log(err)
                else
